/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ffa74af649ba80606d60b121943a8deb)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	MEMORY_CATALOG: D1Database;
	MEMORIES: VectorizeIndex;
	AI: Ai;
	ALLOWED_USER_ID: "user_2WmGvirCeic7h9XFQznaJXB4gkr";
	ALLOWED_HOSTS: "mcp-memory.thekevinwang.workers.dev,localhost,127.0.0.1";
	MCP_RESOURCE_URL: "https://mcp-memory.thekevinwang.workers.dev/mcp";
	CLERK_ISSUER: "https://clerk.thekevinwang.com";
	CLERK_OAUTH_CLIENT_ID: "AWn8M9abalbMqWIm";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_USER_ID" | "ALLOWED_HOSTS" | "MCP_RESOURCE_URL" | "CLERK_ISSUER" | "CLERK_OAUTH_CLIENT_ID" | "CLERK_SECRET_KEY" | "CLERK_OAUTH_CLIENT_SECRET" | "ADMIN_SESSION_SECRET">> {}
}

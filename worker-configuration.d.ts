/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 11cabbb166c80be516a2096db658a299)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	MEMORIES: VectorizeIndex;
	AI: Ai;
	ALLOWED_HOSTS: ["mcp-memory.thekevinwang.workers.dev"];
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_HOSTS" | "MCP_RESOURCE_URL" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY">> {}
}
